# -*- coding: utf-8 -*-
"""ucVisualizeResults.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1C7NzE41lYrDvKH6IjE-BKFo_kQoCNUCT
"""
...
from ucpreprocess import cropVolume, cropVolumes
import ucmodel as net
import os
...
# note about code in general: the more confusing aspects of working with big data
# is the mapping of the file directories

if __name__ == '__main__':
    #data_dir = './data/test/' # evaluate on original data and not the processed one
    data_dir = '/content/drive/My Drive/testing/'
    test_file = 'test.txt'
    ...
    ##best_model_loc = '/content/drive/My Drive/espnet_3d_brats.pth'
    # create pretrained folder drag .pth into it
    best_model_loc = './pretrained/espnet_3d_brats.pth'
